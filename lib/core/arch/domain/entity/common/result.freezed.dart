...
class _$ResultSuccessImpl<T> extends _ResultSuccess<T> {
  const _$ResultSuccessImpl(this.data) : super._();
...
abstract class _ResultSuccess<T> extends Result<T> {
  const factory _ResultSuccess(final T data) = _$ResultSuccessImpl<T>;
...
class _$ResultErrorImpl<T> extends ResultError<T> {
  const _$ResultErrorImpl({required this.failure}) : super._();
...
abstract class ResultError<T> extends Result<T> {
  const factory ResultError({required final Failure failure}) =
      _$ResultErrorImpl<T>;
